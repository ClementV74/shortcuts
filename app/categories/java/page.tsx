...
export default function JavaLanguagePage() {
  ...
  const syntaxItems: SyntaxItem[] = [
    // Basic syntax
    {
      ...
      description: "Déclaration d'une classe Java",
      example: "public class MyClass {\n  // Class body\n}",
      category: "basic",
    },
    {
      name: "main method",
      description: "Point d'entrée principal d'un programme Java",
      example:
    ...
    {
      name: "package",
      description: "Regroupement de classes liées",
      example: "package com.example.myapp;\n\npublic class MyClass {\n  // Class body\n}",
      category: "basic",
    },
    {
      name: "import",
      description: "Importer des classes ou des packages",
      example: "import java.util.ArrayList;\nimport java.util.*; // Import all classes in package",
      category: "basic",
    },
    {
      name: "System.out.println()",
      description: "Afficher du texte dans la console",
      example:
    ...
    {
      name: "comments",
      description: "Commentaires en Java",
      example:
    ...
    {
      name: "arrays",
      description: "Collections d'éléments du même type",
      example:
    ...
    {
      name: "ArrayList",
      description: "Liste dynamique redimensionnable",
      example:
    ...
    {
      name: "enum",
      description: "Type de données pour un ensemble de constantes",
      example:
    ...
    {
      name: "class",
      description: "Modèle pour créer des objets",
      example:
    ...
    {
      name: "inheritance",
      description: "Mécanisme pour dériver une classe d'une autre",
      example:
    ...
    {
      name: "interface",
      description: "Contrat spécifiant des méthodes qu'une classe doit implémenter",
      example:
    ...
    {
      name: "abstract class",
      description: "Classe qui ne peut pas être instanciée et peut contenir des méthodes abstraites",
      example:
    ...
    {
      name: "polymorphism",
      description: "Capacité d'un objet à prendre plusieurs formes",
      example:
    ...
    {
      name: "encapsulation",
      description: "Masquer les détails d'implémentation et restreindre l'accès aux données",
      example:
    ...
    {
      name: "switch",
      description: "Structure de contrôle multi-voies",
      example:
    ...
    {
      name: "for loop",
      description: "Boucle avec initialisation, condition et incrémentation",
      example:
    ...
    {
      name: "do-while loop",
      description: "Boucle qui s'exécute au moins une fois",
      example: "int count = 5;\ndo {\n  System.out.println(count);\n  count--;\n} while (count > 0);",
      category: "control",
    },
    {
      name: "break and continue",
      description: "Contrôler le flux d'exécution dans les boucles",
      example:
    ...
    {
      name: "throws",
      description: "Déclarer qu'une méthode peut lancer des exceptions",
      example:
    ...
    },
    {
      ...
      description: "Gérer automatiquement les ressources qui doivent être fermées",
      example:
    ...
    {
      name: "List",
      description: "Interface pour les collections ordonnées",
      example:
    ...
    {
      name: "Set",
      description: "Interface pour les collections sans doublons",
      example:
    ...
    {
      name: "Map",
      description: "Interface pour les collections de paires clé-valeur",
      example:
    ...
    {
      name: "generics",
      description: "Paramètres de type pour les classes et méthodes",
      example:
    ...
    {
      name: "Thread",
      description: "Unité d'exécution légère",
      example:
    ...
    {
      name: "synchronized",
      description: "Mécanisme pour contrôler l'accès concurrent aux ressources partagées",
      example:
    ...
    },
    {
      ...
      description: "Framework pour exécuter des tâches asynchrones",
      example:
  ...
  const categories = [
    ...
    {
      id: "collections",
      name: "Collections et génériques",
      icon: "📚",
    },
    { id: "concurrency", name: "Concurrence", icon: "⚡" },
  ]
    ...
    <div className="container px-4 py-12 md:py-16">
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h1 className="text-4xl font-bold tracking-tight">Java</h1>
        </div>
